# /fix-new-issues [PR-NUMBER] — Fix SonarCloud quality issues on PR (Codex)
...
7. **Stage and Commit** — After all fixes pass validation:
   ...
   - Commit with message: `[fix] SonarCloud issues on PR #{PR}: coverage, duplication, security hotspots (apsc - cx)`
