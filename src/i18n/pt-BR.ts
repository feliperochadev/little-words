export default {
  ...
  settings: {
    ...
    profileSectionTitle: 'Perfil {{label}}',
    girl: 'Menina',
    boy: 'Menino',
    ...
    categoriesExpand: 'Gerenciar categorias',
    categoriesCollapse: 'Ocultar categorias',
  },
  ...
  // ── Add Variant Modal ────────────────────────────────────────────────────────
  addVariant: {
    titleNew: 'Nova Variante',
    titleEdit: 'Editar Variante',
    wordLabel: 'Palavra *',
  ...
  notifications: {
    ...
    milestoneFirstTitle: 'Primeira palavra! 🚨',
    milestoneFirstBody: 'Você começou a jornada de {{childName}}. Continue assim!',
    milestoneTitle: 'Marco alcançado! 🎉',
    milestoneBody: "Essa foi a {{count}}ª palavra de {{childName}}! O dicionário está crescendo!",
  },
};
