export default {
  ...
  settings: {
    ...
    googleDesc: 'Faça backup automático das palavras no seu Google Drive. Sincroniza a cada nova palavra adicionada.',
    syncSuccess: '✅ Sincronizado!',
    syncSuccessMsg: 'Backup salvo no Google Drive.',
    saveCsvSuccess: '✅ Salvo!',
    saveCsvMsg: 'Arquivo CSV salvo na pasta escolhida.',
    disconnectTitle: 'Desconectar Google Drive',
    disconnectMsg: 'Tem certeza? Os dados locais não serão removidos.',
    ...
    errorSync: 'Falha ao sincronizar.',
    sessionExpired: 'Sessão expirada. Conecte novamente.',
    language: 'Idioma',
