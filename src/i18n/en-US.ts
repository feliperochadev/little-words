export default {
  ...
  variants: {
    ...
    emptyNoWordsSubtitle: 'Add some words first before creating pronunciation variants.',
    addFirst: 'Add First Variant',
  ...
  settings: {
    ...
    categoriesExpand: 'Manage categories',
    categoriesCollapse: 'Hide categories',
  },
  ...
  notifications: {
    ...
    milestoneFirstTitle: 'First word! 🚨',
    milestoneFirstBody: "You've started {{childName}}'s journey. Keep it up!",
    milestoneTitle: 'Milestone! 🎉',
    milestoneBody: "That was {{childName}}'s {{count}}th word! The dictionary is growing!",
  },
};
